...
namespace Attack
{
    ...
    NimBLEAdvertisementData BLE::adv_sour_apple()
    {
        ...
        packet[i++] = 0x00; // ... space near company and type
        packet[i++] = 0x0F; // Type
    ...
    void BLE::start_sour_apple()
    {
        delay(40);
        NimBLEAdvertisementData advertisementData = adv_sour_apple();
